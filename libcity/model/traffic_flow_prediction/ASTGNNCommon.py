...
class ASTGNNCommon(AbstractTrafficStateModel):
    ...
    def train_predict(self, batch):
        ...
        return self.decode(de, encoder_output).transpose(-2, -3)
    ...
    def predict(self, batch):
        ...
        return predict_output.transpose(-2, -3)
    ...
    def get_label(self, batch):
        return batch['y'].transpose(1, 2).transpose(2, 3)[: ,: ,:self.output_dim ,:].transpose(-1, -2).transpose(-2, -3)  # B N T F
